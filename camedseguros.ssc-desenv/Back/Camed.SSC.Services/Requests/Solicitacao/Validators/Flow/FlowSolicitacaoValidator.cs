...
namespace Camed.SSC.Application.Requests.Solicitacao.Validators.Flow
{
    public class FlowSolicitacaoValidator : AbstractValidator<FlowSolicitacaoCommand>
    {
        public FlowSolicitacaoValidator()
        {
            ValidateFlowSolicitacao();
        }

        private void ValidateFlowSolicitacao()
        {
            RuleFor(p => p.Numero)
