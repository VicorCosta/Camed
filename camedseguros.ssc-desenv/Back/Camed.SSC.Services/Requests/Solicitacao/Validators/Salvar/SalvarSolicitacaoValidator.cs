...
{
    public class SalvarSolicitacaoValidator : AbstractValidator<SalvarSolicitacaoCommand>
    {
        public SalvarSolicitacaoValidator()
        {
            ValidateSalvarSolicitacao();
        }

        private void ValidateSalvarSolicitacao()
        {
            RuleFor(p => p.Numero)
