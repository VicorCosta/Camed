...
namespace Camed.SSC.Application.Requests.Solicitacao.Validators.CriarCopiaSolicitacao
{
    public class CriarCopiaSolicitacaoValidator : AbstractValidator<CriarCopiaSolicitacaoCommand>
    {
        public CriarCopiaSolicitacaoValidator()
        {
            ValidateCriarCopiaSolicitacao();
        }

        private void ValidateCriarCopiaSolicitacao()
        {
            RuleFor(p => p.Numero)
