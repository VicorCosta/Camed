...
{
    public class SalvarSolicitacaoCommand : CommandBase, IRequest<IResult>
    {
        public SalvarSolicitacaoCommand()
        {
            this.Anexos = new List<AnexoDeSolicitacaoViewModel>();
        ...
        public Domain.Entities.Solicitante Solicitante { get; set; }
        ...
        public virtual List<AnexoDeSolicitacaoViewModel> Anexos { get; set; }
        ...
        {
            ValidationResult = new SalvarSolicitacaoValidator().Validate(this);
