...
{
    public class PostSolicitacaoCommand : CommandBase, IRequest<IResult>
    {
        public PostSolicitacaoCommand()
        {
        ...
        {
            ValidationResult = new PostSolicitacaoValidator().Validate(this);
