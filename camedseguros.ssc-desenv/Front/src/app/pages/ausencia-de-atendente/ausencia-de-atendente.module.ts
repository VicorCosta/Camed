...
import { ListAusenciaDeAtendenteComponent } from './list';
import { FormAusenciaDeAtendenteComponent } from './form';
...
const routes: Routes = [
  { path: '', component: ListAusenciaDeAtendenteComponent },
  { path: 'cadastrar', component: FormAusenciaDeAtendenteComponent },
  { path: 'editar/:id', component: FormAusenciaDeAtendenteComponent }
...
@NgModule({
  ...
  declarations: [
    ListAusenciaDeAtendenteComponent,
    FormAusenciaDeAtendenteComponent
  ],

  providers: [
    AusenciaDeAtendenteServices,
    UsuarioService,
    EmpresaService,
    TipoSeguroService,
    AgenciaService,
...
export class AusenciaDeAtendenteModule { }
