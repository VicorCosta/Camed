...
@Component({
  templateUrl: './list-tipos-de-parametros.component.html'
})

export class ListTipodeParametrosComponent extends BaseComponent implements OnInit {
  display = false;
  ...
  constructor(private empresaService: TipodeParametroService,
...
this.angularGrid.gridService.resetGrid();
  ...
  remover(item) {
    Swal.fire({
      title: 'Atenção!',
      text: `Deseja excluir o parâmetro: ${item.dataContext.nome}?`,
      type: 'warning',
